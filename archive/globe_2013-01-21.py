...
TODO
* fix walk stuttering
* fix axis flipping while jumping
* make jumping a fully projectile motion
* associate Player with a camera and model
"""
...
class Player(object):
    def __init__(self, position=(0,0,0), height=1, texture=NONE):
        self.camera = Camera()
...
class Window(pyglet.window.Window):
    def __init__(self, *args, **kwargs):
        ...
        self.player = Sphere(radius=2, position=(280, 58, 43), visible=False)
    ...
    def on_key_press(self, symbol, modifiers):
        if symbol in (key.W, key.UP):
            ...
            #self.walk_speed = 15 if self.flying else 15
